...
/** Hero section (matches Contentful Hero content type: internalName, headline, subheadline, media, background, ctaText, ctaUrl, sectionStyle, sectionStyleUpdatedAt, variant, nt_experiences). */
